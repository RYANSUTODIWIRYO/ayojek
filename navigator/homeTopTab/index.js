        ...
        return (
            ...
            >
                <Tab.Screen
                    ...
                    options={{
                        tabBarIcon: () => (
                            <IconBottom image={images.promoImage}/>
                        )  
                    }}
                />
                <Tab.Screen
                    ...
                    options={{
                        tabBarIcon: () => (
                            <IconBottom image={images.homeImage}/>
                        )  
                    }}
                />
                <Tab.Screen
                    ...
                    options={{
                        tabBarIcon: () => (
                            <IconBottom image={images.chatImage}/>
                        )  
                    }}
                />
            </Tab.Navigator>
...
const IconBottom = (props) => {
    return (
        <View>
            <Image source={props.image} style={{width:20, height:20, tintColor: "white"}} />
        </View>
    )
}
